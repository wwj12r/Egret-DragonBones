class page4{
    ...
    public static page4title;
    public static init(){
        let page4 = new Gif('page4', true);
        page4.x = 9600;
        page4.y = 450;
        page4.scaleX = 2;
        page4.scaleY = 2;
        ...
        let heye1 = new egret.Bitmap(RES.getRes("heye1_png"));
        ...
        let heye3 = new egret.Bitmap(RES.getRes("heye3_png"));
        ...
        let fish5 = new egret.Bitmap(RES.getRes("fish5_png"));
        ...
        let fish6 = new egret.Bitmap(RES.getRes("fish5_png"));
        ...
        let heye2 = new egret.Bitmap(RES.getRes("heye2_png"));
        ...
        let fish7 = new egret.Bitmap(RES.getRes("fish5_png"));
        ...
        let heye4 = new egret.Bitmap(RES.getRes("heye4_png"));
        ...
        let boy = new egret.Bitmap(RES.getRes("boy_png"));
        gameStart.middleLayer.addChild(boy);
        boy.x = 10400;
        boy.y = 579;

        let tree_fire = new egret.Bitmap(RES.getRes("tree_fire_png"));
