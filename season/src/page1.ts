class page1{
    ...
    public static page1title = new egret.Bitmap;
    public static init(){
        let page1 = new Gif('page1', true);
        page1.x = 7365;
        page1.y = 370;
        page1.scaleX = 2;
        page1.scaleY = 2;
        ...
        let tree = new egret.Bitmap(RES.getRes("tree_png"));
        gameStart.middleLayer.addChild(tree);
        tree.x = 2310;
        tree.y = 0;

        let xianren = new egret.Bitmap(RES.getRes("xianren_png"));
        ...
        let tree_light = new egret.Bitmap(RES.getRes("tree_light_png"));
        ...
        let tree_halo = new egret.Bitmap(RES.getRes("tree_halo_png"));
