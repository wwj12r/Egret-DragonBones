class page5{
    ...
    public static page5title;
    public static init(){
        let lake = new egret.Bitmap(RES.getRes("lake_jpg"));
        ...
        let color = new egret.Bitmap(RES.getRes("color_png"));
        ...
        let cloud2 = new egret.Bitmap(RES.getRes("cloud2_png"));
        ...
        let cloud1 = new egret.Bitmap(RES.getRes("cloud1_png"));
        ...
        let halo = new egret.Bitmap(RES.getRes("halo_png"));
        ...
        let cloud3 = new egret.Bitmap(RES.getRes("cloud3_png"));
        ...
        let cloud4 = new egret.Bitmap(RES.getRes("cloud3_png"));
