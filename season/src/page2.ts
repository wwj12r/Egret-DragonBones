class page2{
    ...
    public static page2title;
    public static init(){
        let page2 = new Gif('page2', true);
        page2.x = 7250;
        page2.y = 400;
        page2.scaleX = 2;
        page2.scaleY = 2;
        ...
        let xiaoguang = new egret.Bitmap(RES.getRes("xiaoguang_png"));
        ...
        let fish1 = new egret.Bitmap(RES.getRes("fish1_png"));
        ...
        let fish2 = new egret.Bitmap(RES.getRes("fish2_png"));
        ...
        let fish3 = new egret.Bitmap(RES.getRes("fish3_png"));
        ...
        let fish4 = new egret.Bitmap(RES.getRes("fish4_png"));
        ...
        let snake = new egret.Bitmap(RES.getRes("snake_png"));
        ...
        let kite = new egret.Bitmap(RES.getRes("kite_png"));
